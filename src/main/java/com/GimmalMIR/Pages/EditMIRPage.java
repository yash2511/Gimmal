...
public class EditMIRPage {
	...
	public void enterTheRuleForm()
	{
		try{
			...
			Thread.sleep(2000);
			Testfactory.selectWebElement(Testfactory.driver.findElements(By.xpath("//ul[@id='carbonAssetPickerTreeview_5_ul']/li/a")),ExcelUtils.getSheetData(9, 2));
			...
			Thread.sleep(2000);
			Testfactory.selectWebElement(Testfactory.driver.findElements(By.xpath("//ul[@id='carbonAssetPickerTreeview_4_ul']/li/a")),ExcelUtils.getSheetData(9, 3));
			Thread.sleep(1000);
	...
	{
	try{
		boolean title, contentType, field,mode, forceValue, value;
		title = Testfactory.driver.findElement(By.xpath("//a[@class and contains(text(),'" + ExcelUtils.getSheetData(1, 0) + "')]")).isDisplayed();
		contentType = Testfactory.driver.findElement(By.xpath("//span[contains(text(), 'MRA Content Type')]")).isDisplayed();
		field= Testfactory.driver.findElement(By.xpath("//span[contains(text(), '2013 MRA Choice (Choice)')]")).isDisplayed();
		mode=Testfactory.driver.findElement(By.xpath("//td[contains(text(), '" + ExcelUtils.getSheetData(1, 1) + "')]")).isDisplayed();
		forceValue=Testfactory.driver.findElement(By.xpath("//td[contains(text(), '" + ExcelUtils.getSheetData(1, 2) + "')]")).isDisplayed();
		value=Testfactory.driver.findElement(By.xpath("//td[contains(text(), '" + ExcelUtils.getSheetData(1, 3) + "')]")).isDisplayed();
		Assert.assertTrue(title&&contentType&&field&&mode&&forceValue&&value); 
	}catch(Exception e)
	{
		e.printStackTrace();
	}
