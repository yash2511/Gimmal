...
public class MetadataInheritanceRulesPage{
	...
	List<WebElement> allSitesEllipsis = Testfactory.driver.findElements(By.xpath("//a[@class='ms-lstItmLinkAnchor ms-ellipsis-a']"));
	...
	@FindBy(xpath="//a[@href='https://gimmalqaindia.sharepoint.com/sites/MIR_MRA']")
